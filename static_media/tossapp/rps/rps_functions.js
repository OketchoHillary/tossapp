...
function hideReplayButtom() {
    // Hide Replay Button
    var rbtx = app.renderer.view.width / 2 - replayButtonGroup.width / 2 + 13;
    var rbty = app.renderer.view
        .height / 2 - replayButtonGroup.height / 2 + 300;
...
function recoverReplayButton() {
    ...
    var rbtx = app.renderer.view.width / 2 - replayButtonGroup.width / 2 + 13;
    var rbty = app.renderer.view.height / 2 - replayButtonGroup.height / 2 + 160;
