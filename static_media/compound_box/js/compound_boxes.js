...
PIXI.loader.add(["images/rps.json", "images/clear_bet_button.png", "images/reset_game_buttom.png"]).on("progress", loadProgressHandler).load(setup);
...
function setup() {
    ...
    //frame id textures.
    id = PIXI.loader.resources["images/compound_boxes.json"].textures;
    ...
    clear_bet_button = new Sprite(resources["images/clear_bet_button.png"].texture);
    ...
    //MAKING THE clear_bet_button. To Clear the bet
    reset_game_button = new Sprite(resources["images/reset_game_buttom.png"].texture);
    ...
    rockButton.on('pointerdown', rockButton_pressed);
    paperButton.on('pointerdown', paperButton_pressed);
    scissorButton.on('pointerdown', scissorButton_pressed);
    reset_game_button.on('pointerdown', reset_game_button_pressed);

    add_bet_btn.on('pointerdown', add_bet_btn_pressed);
    subtract_bet_btn.on('pointerdown', subtract_bet_btn_pressed);
    clear_bet_button.on('pointerdown', clear_bet_button_pressed);

    black_100_casino_chip.on('pointerdown', black_100_casino_chip_pressed);
    blue_500_casino_chip.on('pointerdown', blue_500_casino_chip_pressed);
    green_1000_casino_chip.on('pointerdown', green_1000_casino_chip_pressed);
    red_5000_casino_chip.on('pointerdown', red_5000_casino_chip_pressed);
